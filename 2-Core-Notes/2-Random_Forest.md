...
### Best ways to detect co-relation and bypass this trap:
   1.  Calculate VIF on your training data,Identify the group of features with high VIF scores (usually VIF > 5 or 10).Permute them
       together as a block on the held-out test data.
