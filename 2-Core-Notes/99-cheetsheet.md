...
```
#FeatureUnion - Passes the entire input dataset to every transformer, then merges the result.
#ColumnTransformer-Applies different transformers to specific subsets or columns of the data.
